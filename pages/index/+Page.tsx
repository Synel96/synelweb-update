...
export default function Page() {
  ...
  return (
    <>
      ...
      <div
        aria-hidden="true"
        className="h-16 w-full bg-[linear-gradient(100deg,var(--color-secondary-warm),var(--color-accent))] [clip-path:polygon(0_0,100%_0,100%_70%,0_100%)] blur-[6px] sm:h-24 sm:blur-[8px] md:h-32"
      />
